...
const AliCloudKMSBackend = require('../lib/backends/alicloud-kms-backend')
...
const alicloudKMSBackend = new AliCloudKMSBackend({
  client: alicloudConfig.kmsClient,
  logger
})
const backends = {
  ...
  alicloudKMS: alicloudKMSBackend
}
