...
| `env.TENCENTCLOUD_REGION`                 | Set TENCENTCLOUD_REGION (from a secret) in Deployment Pod                                                                         | `nil`                                 |
| `env.TENCENTCLOUD_METADATA_HOST`          | Set TENCENTCLOUD_METADATA_HOST for STS Service in Deployment Pod (optional)                                                       | `metadata.tencentyun.com`             |
| `env.TENCENTCLOUD_METADATA_PATH`          | Set TENCENTCLOUD_METADATA_PATH for STS Service in Deployment Pod (optional)                                                       | `latest/meta-data/cam/security-credentials` |
| `env.TENCENTCLOUD_SSM_ENDPOINT`           | Set TENCENTCLOUD_SSM_ENDPOINT for SSM Service in Deployment Pod (optional)                                                        | `ssm.tencentcloudapi.com`             |
...
| `envVarsFromSecret.TENCENTCLOUD_SECRET_ID`     | Set TENCENTCLOUD_SECRET_ID (from a secret) in Deployment Pod                                                                 |                                       |
| `envVarsFromSecret.TENCENTCLOUD_SECRET_KEY`    | Set TENCENTCLOUD_SECRET_KEY (from a secret) in Deployment Pod                                                                |                                       |
...
| `image.tag`                               | kubernetes-external-secrets Image tag                                                                                             | `8.2.2`                               |
