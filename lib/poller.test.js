...
describe('Poller', () => {
  ...
  describe('_createSecretManifest', () => {
    ...
    it('creates secret manifest with version suffix if one is given', async () => {
      const poller = pollerFactory({
        backendType: 'fakeBackendType',
        name: 'fakeSecretName',
        properties: [
      ...
      const secretManifest = await poller._createSecretManifest('v123')
