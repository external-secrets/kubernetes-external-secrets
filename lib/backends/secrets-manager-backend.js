...
class SecretsManagerBackend extends KVBackend {
   ...
   * @param {string} secretVersion - VersionStage for secret. Default is AWSCURRENT.
   * @returns {Promise} Promise object representing secret property value.
   */
  async _get ({ secretKey, secretVersion = 'AWSCURRENT', roleArn }) {
    ...
    const data = await client
      .getSecretValue({ SecretId: secretKey, VersionStage: secretVersion })
      .promise()
