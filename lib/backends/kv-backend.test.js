...
describe('SecretsManagerBackend', () => {
  ...
  describe('_fetchSecretPropertyValues', () => {
    ...
    it('fetches secret property values', async () => {
      ...
      expect(loggerMock.info.calledWith('fetching secret property fakePropertyName1')).to.be.true;
      expect(loggerMock.info.calledWith('fetching secret property fakePropertyName2')).to.be.true;
